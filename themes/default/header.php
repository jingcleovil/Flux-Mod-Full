...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo $this->themePath('css/tabs.css') ?>" type="text/css" media="screen" title="" charset="utf-8" />
		<link rel="stylesheet" href="<?php echo $this->themePath('css/mod.css') ?>" type="text/css" media="screen" title="" charset="utf-8" />
		...
		<![endif]-->
		<script type="text/javascript" src="<?php echo $this->themePath('js/jquery-1.6.2.min.js') ?>"></script>
