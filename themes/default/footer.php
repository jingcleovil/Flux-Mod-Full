<?php if (!defined('FLUX_ROOT')) exit; ?>
		...
		<script type="text/javascript" src="<?php echo $this->themePath('js/tabs.js') ?>"></script>
		<script type="text/javascript" src="<?php echo $this->themePath('js/script.js') ?>"></script>
		
		<?php if ($session->isLoggedIn()): ?> 
			<?php if(in_array($params->get('module'),array('character'))):?> 
				<script type="text/javascript" src="<?php echo $this->themePath('js/account.js') ?>"></script>
			<?php endif?>
			<?php if(in_array($params->get('module'),array('character'))):?> 
				<script type="text/javascript" src="<?php echo $this->themePath('js/character.js') ?>"></script>
			<?php endif?>
		<?php endif?>
